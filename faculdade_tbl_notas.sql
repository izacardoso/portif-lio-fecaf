...
CREATE TABLE `tbl_notas` (
  ...
  CONSTRAINT `tbl_notas_ibfk_1` FOREIGN KEY (`id_aluno`) REFERENCES `tbl_alunos` (`id_aluno`),
  CONSTRAINT `tbl_notas_ibfk_2` FOREIGN KEY (`id_materia`) REFERENCES `tbl_materias` (`id_materia`)
...
-- Dump completed on 2024-09-30 22:26:09
